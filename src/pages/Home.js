    ...
    return (
        <PageWrapper>
            <header className="max-w-3xl mx-auto text-center mt-5 md:mt-12">
                <h1 className="text-4xl md:text-6xl font-extrabold text-blue-800 mb-2 md:mb-4">Seemles Tracking of Birthdays and all Events </h1> 
            ...
            <section id="upcoming-events" className="max-w-2xl mx-auto bg-white rounded-2xl shadow-2xl p-8 my-16">
