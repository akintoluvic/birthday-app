...
const Navbar = () => {
    return (
        <header class="fixed container bg-gray-800 text-gray-600 shadow">
            <div class="flex justify-between py-5 items-center">
                <Link to="/" class="flex title-font font-medium items-center">
                    ...
                    <span class="hidden md:inline ml-3 text-xl">Birthday App</span>
                </Link>
                <nav class="ml-auto flex flex-wrap items-center text-base justify-center">
                    <Link to="/" class="mr-5 hover:text-gray-900">Home</Link>
                    <Link to="/new" class="mr-5 hover:text-gray-900">Add New</Link>
                    <Link to="/details" class="mr-5 hover:text-gray-900">Full Details</Link>
                </nav>
            </div>
        </header>
    )
