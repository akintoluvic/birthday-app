...
const Navbar = () => {
    return (
        <header className="fixed w-full bg-white text-gray-600 ">
            <div className="container flex justify-between py-5 items-center">
                ...
                <nav className="ml-auto flex flex-wrap items-center text-base justify-center">
                    ...
                    <Link to="/new" className="mr-5 hover:text-gray-900">Add New</Link>
                    <Link to="/details" className="mr-5 hover:text-gray-900">Full Details</Link>
                </nav>
            </div>
        </header>
    )
